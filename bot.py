...
def sync_existing_positions():
    ...
    for pos in positions:
        ...
        # Хамгаалалт байгаа эсэхийг шалгах (энгийн арга: algo orders байгаа эсэх)
...
def execute_trades(selected_coins, total_balance):
    ...
    for coin in selected_coins:
        ...
        success = rebuild_protection_orders(symbol, signal, actual_quantity, entry_price, actual_position_side)
        if not success:
...
def manage_dca():
    ...
    for pos in positions:
        ...
        # Rebuild protection
        if not rebuild_protection_orders(symbol, side, actual_qty, new_avg, refreshed.get("positionSide", position_side)):
