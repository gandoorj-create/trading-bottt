...
# ---- Нууц (secrets) - ШУУД ОРУУЛСАН ----
API_KEY = os.environ.get("BINANCE_API_KEY", "tyRDudce0UlVVEA9jqLRbiHulMGlCtzIMsBQqduZtrARuxFhHgJJVuoYk7l3TvrG")
API_SECRET = os.environ.get("BINANCE_API_SECRET", "4NuMPGZhbsMfAerDIQeyBV0vR1v7aOuwSh8tm3RrQUPm1HkUNf1DQB98neXutUKX")
BASE_URL = os.environ.get("BINANCE_BASE_URL", "https://demo-fapi.binance.com")

BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "8786518803:AAG8yVyTdBfOw0pOsieHOynoQnt7Qr7nl94")
CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID", "6886167068")
