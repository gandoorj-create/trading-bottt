...
# Портфелийн НИЙТ drawdown хязгаар (session-ий peak балансаас хэдэн хувь буурвал
# бүх trading-ийг бүрмөсөн зогсоох вэ). 0 буюу key байхгүй бол ФУНКЦ УНТАРСАН.
